document.addEventListener("DOMContentLoaded", function () {
  ...
  var submitBtn = document.getElementById("contact_form_btn");
...
// Update your carousel initialization code to include this
function initializeCarousels() {
  // For Services Carousel
  const servicesCarousel = document.getElementById('services-carousel');
  if (servicesCarousel) {
      // Remove any existing inline styles that might cause gaps
      servicesCarousel.style.paddingRight = '0';
      servicesCarousel.style.marginRight = '-1rem';
  }

  // For Projects Carousel
  const projectsCarousel = document.getElementById('projects-carousel'); // Update ID if different
  if (projectsCarousel) {
      projectsCarousel.style.paddingRight = '0';
      projectsCarousel.style.marginRight = '-1rem';
  }
}
